...
*The European Dream* is a must read for someone who moved to North America from Europe as it compares the difference in lifestyles between continents. The last two books in the list could open your eyes on the startup culture in the Silicon Valley.
...
Surprisingly, the programming language of the year for me was Lua. I would never imagine what sorts of things you could [create](https://github.com/openresty/lua-nginx-module){:target="_blank"} with LuaJIT embedded into NGINX.
